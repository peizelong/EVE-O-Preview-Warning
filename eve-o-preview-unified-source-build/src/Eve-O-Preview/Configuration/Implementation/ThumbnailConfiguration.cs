...
namespace EveOPreview.Configuration.Implementation
{
	sealed class ThumbnailConfiguration : IThumbnailConfiguration
	{
		...
		[JsonProperty("AlertConfirmationFrames")]
		public int AlertConfirmationFrames { get; set; }

		[JsonProperty("AlertClearFrames")]
		public int AlertClearFrames { get; set; }

		[JsonProperty("MinAlertDurationMs")]
		public int MinAlertDurationMs { get; set; }
		...
		{
			return this.PerClientRoi != null && this.PerClientRoi.TryGetValue(clientTitle, out var r) ? r : Rectangle.Empty;
		}

		public void SetRoi(string clientTitle, Rectangle roi)
		{
			if (this.PerClientRoi == null) this.PerClientRoi = new Dictionary<string, Rectangle>();
